...
When creating pull requests or managing issues, use the GitHub MCP (or `gh` CLI):
...
**When to use:**
- After committing, to create a PR
- To link commits to issues
- To manage PR reviews and merges
